# Report Style Profile Schema

Use this schema when establishing or updating a reusable report style profile. It records how the report should sound, look, and be structured. Record what the recipient values and how they judge progress in the separate [recipient profile](recipient-profile-schema.md).

Record only information supported by a user statement, supplied template, recipient feedback, or behavioral evidence. Mark inferences explicitly and persist feedback- or behavior-derived rules only after user confirmation.

## Profile metadata

- Associated recipient profile:
- Profile version:
...
- Available sources:
  ...
  - confirmed recipient feedback or behavioral evidence;
  - recipient template;
...
- User-described preferences and confirmed feedback/behavior-derived rules:
